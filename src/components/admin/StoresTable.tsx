...
import { getStores, updateStoreStatus, getStorePaymentDetails } from '@/lib/api';
import { Store, StorePagination, StorePaymentDetails, StoreContactInfo } from '@/lib/types';
